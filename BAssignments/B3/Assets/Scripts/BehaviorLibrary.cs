...
public class BehaviorLibrary : MonoBehaviour {
	...
	public GameObject person12;

	public GameObject soldier;
	public GameObject roma;
	public GameObject door;

	public Transform meeting_point1;
	public Transform meeting_point2;
	public Transform meeting_point3;
	public Transform meeting_point4;
	public Transform meeting_point5;
	public Transform meeting_point6;
	...
	protected Node MeetingArc(GameObject person, Transform meeting_point1, Transform meeting_point2)
	{
		return new Sequence (

			new SequenceParallel(
				this.GoToPointAround(person1, meeting_point1, 1.0f),
				this.GoToPointAround(person2, meeting_point1, 1.0f)
			),
	...
	protected Node AlwaysWander(GameObject person)
	{
		return new DecoratorLoop(

			new Sequence(
				new SelectorShuffle(
				this.GoToPointAround(person, meeting_point1, 1.0f),
				this.GoToPointAround(person, meeting_point2, 1.0f),
				this.GoToPointAround(person, meeting_point3, 1.0f),
				this.GoToPointAround(person, meeting_point4, 1.0f),
				this.GoToPointAround(person, meeting_point5, 1.0f),
				this.GoToPointAround(person, meeting_point6, 1.0f),
				Speak(person, "Nice Place!", 1000L),
				Speak(person, "Beautiful!", 1000L),
				Speak(person, "Wow! There is a strange person!", 1000L),
				Speak(person, "Hi!", 1000L)
			),
				new LeafWait(1000))
			);
	}
